      ...
      <div className="px-3 py-20 bg-opacity-10 " >
        <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group rounded-md bg-neutral-500 shadow-xl shadow-neutral-100 border ">
            ...
            <div
                ...
                <p className="mt-2 text-sm text-neutral-100">Team BrainEdge education is a bunch of highly focused, energetic
                    set of people.</p>
            </div>
            ...
            <div
                ...
                <p className="text-xl font-medium text-neutral-100 mt-3">Best
                    Test preparation</p>
                <p className="mt-2 text-sm text-neutral-100 ">Know where you stand and what next to do to succeed .</p>
            </div>
            ...
            <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-slate-500 cursor-pointer">
                ...
                <p className="text-xl font-medium text-neutral-100 mt-3">Admission process Guidance</p>
                <p className="mt-2 text-sm text-neutral-100">Professional Advice for higher education abroad and select the
            ...
            <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-slate-500 cursor-pointer">
                ...
                <p className="text-xl font-medium text-neutral-100 mt-3">Best
                    Track Record</p>
                <p className="mt-2 text-sm text-neutral-100">Yet another year ! Yet another jewel in our crown!</p>
            </div>
            ...
            <div className="p-10 flex flex-col items-center text-center group    md:lg:xl:border-r hover:bg-slate-500 cursor-pointer">
                ...
                <p className="text-xl font-medium text-neutral-100 mt-3">Free
                    Mock Exams</p>
                <p className="mt-2 text-sm text-neutral-100">Get Topic-Wise Tests, Section- Wise and mock tests for your
                    preparation.</p>
            </div>
            ...
            <div className="p-10 flex flex-col items-center text-center group hover:bg-slate-500 cursor-pointer">
                ...
                <p className="text-xl font-medium text-neutral-100 mt-3">Genuine
                    Visa Advice</p>
                <p className="mt-2 text-sm text-neutral-100">Visa process by helping you create the necessary documentation
                </p>
            </div>
