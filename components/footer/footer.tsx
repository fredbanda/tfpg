...
const Footer= () => {
  ...
  return (
    <>
<footer
  className="bg-gray-600 text-center text-neutral-100 dark:bg-black/80 dark:text-neutral-200 lg:text-left">
  <div
    ...
    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        ...
        <p className="mb-4 flex items-center justify-center md:justify-start">
          ...
          <Link href={"mailto:info@thefirstpitch.co.za"}>info@thefirstpitch.co.za</Link>
        </p>
        <p className="mb-4 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
